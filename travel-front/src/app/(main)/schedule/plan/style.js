...
export const SortingLayerWrapper = styled(Box)`
  height: 42px;
  margin: 4px 0 4px 0;
  display: flex;
  gap: 10px;
...
export const MinimalViewWrapper = styled(Box)`
  display: flex;
  align-items: center;
`;
export const MinimalText = styled.p`
  ...
  margin-right: 9px;
`;
export const MinimalSwitchBox = styled(Box)`
  width: 48px;
  height: 26px;
  flex-shrink: 0;
  border-radius: 26px;
...
export const MinimalSwitchCircle = styled(Box)`
  height: 24px;
  width: 24px;
...
export const StickerBox = styled(Box)`
  width: 48px;
  height: 48px;
  position: relative;
  background-image: url("${(props) => props.url}");
...
export const TitleOutBox = styled(Box)`
  position: relative;
  display: flex;
  justify-content: center;
  align-items: center;
...
export const TitleInBox = styled(Box)`
  padding: 10px;
  display: flex;
  align-items: center;
  width: 302.925px;
...
export const StickerWrapper = styled(Box)`
  background-image: url("${(props) => props.url}");
  width: 82px;
  height: 42px;
  display: flex;
...
export const PlanPicture = styled(Box)`
  z-index: 7;
  position: relative;
...
export const LineBoxType2 = styled(Box)`
  width: 330px;
  height: 205px;
  flex-shrink: 0;
  top: -230px;
...
export const PlanMiniWrapper = styled(Box)`
  cursor: pointer;
  border-radius: 15px;
  background: #fff;
  box-shadow: 0px 2px 2px 0px rgba(0, 0, 0, 0.25);
...
export const PlanMiniHeader = styled(Box)`
  width: 344px;
  height: 40px;
  flex-shrink: 0;
  background: #e3def3;
...
export const PlanMiniHeaderText = styled.p`
  position: relative;
  left: 130px;
  font-size: 14px;
  font-style: normal;
...
export const PlanMiniDateText = styled.p`
  position: relative;
  width: 200px;
  left: 130px;
  top: -73px;
